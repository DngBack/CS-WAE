...
main_tex="$script_dir/sca_v23_iclr2027.tex"
build_log="$script_dir/sca_v23_iclr2027.log"
pdf_file="$script_dir/sca_v23_iclr2027.pdf"
...
(
  cd "$script_dir"
  latexmk -pdf -interaction=nonstopmode -halt-on-error sca_v23_iclr2027.tex
)
