...
main_tex="$script_dir/main_v19_iclr2027.tex"
build_log="$script_dir/main_v19_iclr2027.log"
pdf_file="$script_dir/main_v19_iclr2027.pdf"
...
(
  cd "$script_dir"
  latexmk -pdf -interaction=nonstopmode -halt-on-error main_v19_iclr2027.tex
)
