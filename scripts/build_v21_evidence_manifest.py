#!/usr/bin/env python3
"""Build an identity-free manifest for the v21 evidence snapshot."""
...
OUTPUT = ROOT / "fcswae" / "v21_evidence_manifest.json"
SIDECAR = OUTPUT.with_suffix(OUTPUT.suffix + ".sha256")

SOURCE_PATHS = [
    "scripts/build_v21_evidence_manifest.py",
    "scripts/audit_v21_anonymity.py",
...
def main() -> None:
    payload = {
        "schema": "iclr2027-v21-evidence-manifest-1.0.0",
        ...
        "provenance": {
            ...
            "note": (
                ...
                "this manifest binds the exact critical source files shipped with v21."
            ),
