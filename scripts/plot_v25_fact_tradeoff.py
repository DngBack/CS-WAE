#!/usr/bin/env python3
"""Render the v25 FACT trade-off panel from the archived matched-pair summary."""
...
OUTPUT = ROOT / "fcswae/figures/v25_fact_tradeoff.pdf"
...
def main() -> None:
    ...
    fig, axes = plt.subplots(1, 2, figsize=(7.05, 1.95), gridspec_kw={"width_ratios": [0.86, 1.55]})
