#!/usr/bin/env python3
"""Audit the v21 submission-facing snapshot for common identity leaks.
...
MANIFEST = ROOT / "fcswae" / "v21_evidence_manifest.json"
OUTPUT = ROOT / "fcswae" / "v21_anonymity_report.json"
SIDECAR = OUTPUT.with_suffix(OUTPUT.suffix + ".sha256")
PDF = ROOT / "fcswae" / "main_v21_iclr2027.pdf"
SELF = Path(__file__).resolve()

BASE_TARGETS = [
    "fcswae/main_v21_iclr2027.tex",
    "fcswae/appendix_v21_iclr2027.tex",
    "fcswae/references.bib",
    "fcswae/README_ICLR2027.md",
    "fcswae/figures/FIGURE_SOURCES.md",
    "fcswae/build_iclr2027_v21_submission.sh",
    "fcswae/v21_evidence_manifest.json",
]
...
def manuscript_graphics() -> list[str]:
    ...
    for manuscript in (
        ROOT / "fcswae" / "main_v21_iclr2027.tex",
        ROOT / "fcswae" / "appendix_v21_iclr2027.tex",
    ):
...
def main() -> None:
    if not MANIFEST.is_file():
        raise FileNotFoundError(
            "generate fcswae/v21_evidence_manifest.json before the anonymity audit"
        )
    target_names = sorted(
    ...
    payload = {
        "schema": "iclr2027-v21-anonymity-audit-1.0.0",
        ...
        "boundary": (
            "The audit covers v21 manuscript sources, included figures, the "
            "submission README/figure-source index, and every source/artifact "
            "listed in the v21 evidence manifest. It does not certify files that "
