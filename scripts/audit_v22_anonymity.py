#!/usr/bin/env python3
"""Audit the v22 submission-facing snapshot for common identity leaks.
...
MANIFEST = ROOT / "fcswae" / "v22_evidence_manifest.json"
OUTPUT = ROOT / "fcswae" / "v22_anonymity_report.json"
SIDECAR = OUTPUT.with_suffix(OUTPUT.suffix + ".sha256")
PDF = ROOT / "fcswae" / "main_v22_iclr2027.pdf"
SELF = Path(__file__).resolve()

BASE_TARGETS = [
    "fcswae/main_v22_iclr2027.tex",
    "fcswae/appendix_v22_iclr2027.tex",
    "fcswae/references.bib",
    "fcswae/README_ICLR2027.md",
    "fcswae/figures/FIGURE_SOURCES.md",
    "fcswae/build_iclr2027_v22_submission.sh",
    "fcswae/v22_evidence_manifest.json",
]
...
def manuscript_graphics() -> list[str]:
    ...
    for manuscript in (
        ROOT / "fcswae" / "main_v22_iclr2027.tex",
        ROOT / "fcswae" / "appendix_v22_iclr2027.tex",
    ):
...
def main() -> None:
    if not MANIFEST.is_file():
        raise FileNotFoundError(
            "generate fcswae/v22_evidence_manifest.json before the anonymity audit"
        )
    target_names = sorted(
    ...
    payload = {
        "schema": "iclr2027-v22-anonymity-audit-1.0.0",
        ...
        "boundary": (
            "The audit covers v22 manuscript sources, included figures, the "
            "submission README/figure-source index, and every source/artifact "
            "listed in the v22 evidence manifest. It does not certify files that "
