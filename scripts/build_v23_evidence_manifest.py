#!/usr/bin/env python3
"""Build an identity-free manifest for the v23 evidence snapshot."""
...
OUTPUT = ROOT / "fcswae" / "v23_evidence_manifest.json"
SIDECAR = OUTPUT.with_suffix(OUTPUT.suffix + ".sha256")

SOURCE_PATHS = [
    "scripts/build_v23_evidence_manifest.py",
    "scripts/build_v23_external_followup_summary.py",
    "scripts/audit_v23_anonymity.py",
...
def main() -> None:
    payload = {
        "schema": "iclr2027-v23-evidence-manifest-1.0.0",
        ...
        "provenance": {
            ...
            "note": (
                ...
                "this manifest binds the exact critical source files shipped with v23."
            ),
