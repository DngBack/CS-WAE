#!/usr/bin/env python3
"""Build an identity-free manifest for the v20 evidence snapshot."""
...
OUTPUT = ROOT / "fcswae" / "v20_evidence_manifest.json"

SOURCE_PATHS = [
    "scripts/build_v20_evidence_manifest.py",
...
def main() -> None:
    payload = {
        "schema": "iclr2027-v20-evidence-manifest-1.0.0",
        ...
        "provenance": {
            ...
            "note": (
                ...
                "this manifest binds the exact critical source files shipped with v20."
            ),
