#!/usr/bin/env python3
"""Build an identity-free manifest for the v26 evidence snapshot."""
...
HEADLINE_ARTIFACT_PATHS = [
    ...
    "runs_diag/fact/mean_hsic_mnist_40e/submission_followup_v1/manifest.json",
    "runs_diag/complete_contract_diagnostics/results.json",
    "fcswae/figures/v26_fact_tradeoff.pdf",
]
...
def main() -> None:
    payload = {
        "schema": "iclr2027-v26-evidence-manifest-1.0.0",
        ...
        "provenance": {
            ...
            "note": (
                ...
                "this manifest binds the exact critical source files shipped with v26."
            ),
