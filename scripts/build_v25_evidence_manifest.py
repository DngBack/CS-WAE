#!/usr/bin/env python3
"""Build an identity-free manifest for the v25 evidence snapshot."""
...
OUTPUT = ROOT / "fcswae" / "v25_evidence_manifest.json"
SIDECAR = OUTPUT.with_suffix(OUTPUT.suffix + ".sha256")

SOURCE_PATHS = [
    "scripts/build_v25_evidence_manifest.py",
    "scripts/build_v23_external_followup_summary.py",
    "scripts/audit_v25_anonymity.py",
    "scripts/plot_v25_fact_tradeoff.py",
    "fcswae/sca_v25_iclr2027.tex",
    "fcswae/appendix_v25_iclr2027.tex",
    "fcswae/build_sca_v25_submission.sh",
...
HEADLINE_ARTIFACT_PATHS = [
    ...
    "fcswae/figures/v25_fact_tradeoff.pdf",
]
...
SECONDARY_ARTIFACT_PATHS = [
    ...
    "fcswae/reported_external_followup_v23.json",
]
...
def main() -> None:
    payload = {
        "schema": "iclr2027-v25-evidence-manifest-1.0.0",
        ...
        "provenance": {
            ...
            "note": (
                ...
                "this manifest binds the exact critical source files shipped with v25."
            ),
        ...
        "headline_artifacts": [describe(path) for path in HEADLINE_ARTIFACT_PATHS],
        "secondary_or_externally_reported_artifacts": [
            describe(path) for path in SECONDARY_ARTIFACT_PATHS
        ],
    }
